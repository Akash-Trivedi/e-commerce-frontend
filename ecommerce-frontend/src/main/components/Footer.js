    ...
    <footer className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap md:text-left text-center order-first">
            ...
            <nav className="list-none mb-10">
              {
                props.tagList.map((tag) => {
                  return <TagListFooter tag={tag} key={tag.tagId} />
                })
              }
            </nav>
          </div>
          {/* pulishers */}
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">Bussiness(our publishers)</h2>
            <nav className="list-none mb-10">
              <li>
                <Link className="text-blue-600 hover:text-gray-800" to="publisher/login">Sign-in</Link>
              </li>
              <li>
                <Link className="text-blue-600 hover:text-gray-800" to="publisher/register">Sign-up</Link>
              </li>
            </nav>
          </div>
        </div>
      ...
      <div className="bg-gray-100">
        <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
          <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            ...
            <span className="ml-3 text-xl">V2L</span>
          </a>
          <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2022 Vocal-to-Local</p>
